...
echo '<br><br><br><br><div id="variabel">';
//'[ "0098" , "0000", "9906", "9907", "0001", "0004", "0007", "0008", "0010", "0011" ]';
...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <div class="w3-dropdown-hover w3-hide-small">
    <button class="w3-button w3-padding-large" title="Notifications"><span class="w3-right">Penanganan Perkara</span></button>     
    <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:300px">
      <a href="#" class="w3-bar-item w3-button">Ketua Majelis</a>
      <a href="#" class="w3-bar-item w3-button">Panitera Pengganti</a>
      <a href="#" class="w3-bar-item w3-button">Jurusita</a>
    </div>
  </div>
...
<!-- Page Container -->
<div class="w3-container w3-content" style="max-width:2000px;margin-top:30px;">    
  <!-- The Grid -->
  <div class="w3-row">
    <!-- Left Column -->
    <div class="w3-col m2">
        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <p contenteditable="true" class="w3-border w3-padding" id="perkara_id">21000</p>
              <button type="button" onClick="show_tabel()" class="w3-button w3-theme"><i class="fa fa-pencil"></i>  Post</button>              
              <table class="w3-table w3-striped w3-border w3-hoverable">
                <thead>
                    <th style="max-width: 5px;text-align:center;">No.</th>
                    <th>Variabel</th>
...
function show_tabel() {
  let perkara_id = $("#perkara_id").text().trim();
  const v = $("#variabel").text().trim();
  $.ajax({
          url: "doc_.php",
          type: "POST",
          data: 'variabel=' + v +'&perkara_id='+perkara_id, 
